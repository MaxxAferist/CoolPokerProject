...
class Mini_menu():
    ...
    def add_buttons(self, other):
        ...
        self.buttons = [Button('Продолжить', (left_top, up_top), (w_btn, h_btn), 43, self.close),
                        Button('Настройки', (left_top, up_top * 2 + h_btn + 20 * KOEF), (w_btn, h_btn), 43, lambda: go_settings(other)),
                        Button('Выйти', (left_top, up_top * 3 + h_btn * 2 + 40 * KOEF), (w_btn, h_btn), 43, lambda: other.go_menu(other.player.money, other.user))]
